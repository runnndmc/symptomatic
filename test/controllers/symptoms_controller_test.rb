...
class SymptomsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create symptom" do
    assert_difference('Symptom.count') do
      post symptoms_url, params: { symptom: { description: @symptom.description, pain_level: @symptom.pain_level, symptom: @symptom.symptom, user_id: @symptom.user_id } }, as: :json
    end
  ...
  test "should update symptom" do
    patch symptom_url(@symptom), params: { symptom: { description: @symptom.description, pain_level: @symptom.pain_level, symptom: @symptom.symptom, user_id: @symptom.user_id } }, as: :json
    assert_response 200
  end
